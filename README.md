...
Atualmente, busco oportunidades como Cientista de Dados, Engenheiro de dados ou Analista onde posso aplicar minhas habilidades em modelagem, análise estatística e desenvolvimento computacional para gerar impacto real nos negócios e projetos.
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="300px" align="center" valign="middle" style="padding: 20px; border-right: 1px solid #0A66C2;">
          <h3 style="color: #0A66C2;">Estimativa de Preço de Laptops</h3>
          <p><b>Stack:</b> Python (Pandas, Scikit-Learn) e XGBoost</p>
          <div align="center">
          ...
          <a href="https://github.com/LeonardoStabile1/Laptop_Price_Estimator">
            <p>Clique aqui para ver o projeto</p>
          </a>
        </td>
        <td width="400px" align="left" valign="middle" style="padding: 20px;">
          <b>Descrição: </b>Pipeline de Machine Learning para prever preços de laptops a partir de especificações de hardware, utilizando Random Forest e XGBoost (RMSE ≈ 195).
        </td>
      </tr>
    </table>
  </div>
